...
[Unimatrix Sync Library](https://github.com/GameChangerFinance/unimatrix), **Roundtable** and **manual** transaction key witness sharing **[signTxs](https://wallet.gamechanger.finance/doc/api/v2/signTxs.html) plugins** allow users to sign transactions almost without noticing a multi-signature scenario is involved. 
