...
- dapp connection code: [GCScript](examples/Transaction%20Time%20to%20Live%20Demo.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Transaction%20Time%20to%20Live%20Demo.html)
