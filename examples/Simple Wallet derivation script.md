...
- dapp connection code: [GCScript](examples/Simple%20Wallet%20derivation%20script.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Simple%20Wallet%20derivation%20script.html)
