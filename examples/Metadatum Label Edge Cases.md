...
- frontend (using @gamechanger-finance/gc): [HTML5 dapp](Metadatum%20Label%20Edge%20Cases.html)
- frontend (without official library): [Native HTML5 dapp](Metadatum%20Label%20Edge%20Cases_nolib.html)
