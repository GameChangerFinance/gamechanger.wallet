...
-  Visit [HTML5 Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Query%20Beacon%20Tokens.html)
...
- frontend (using @gamechanger-finance/gc): [HTML5 dapp](Query%20Beacon%20Tokens.html)
- frontend (without official library): [Native HTML5 dapp](Query%20Beacon%20Tokens_nolib.html)
