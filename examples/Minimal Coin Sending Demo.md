...
- dapp connection code: [GCScript](examples/Minimal%20Coin%20Sending%20Demo.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Minimal%20Coin%20Sending%20Demo.html)
