...
- frontend (using @gamechanger-finance/gc): [HTML5 dapp](GCFS%20Multisig%20Transaction%20Discovery%20Demo.html)
- frontend (without official library): [Native HTML5 dapp](GCFS%20Multisig%20Transaction%20Discovery%20Demo_nolib.html)
