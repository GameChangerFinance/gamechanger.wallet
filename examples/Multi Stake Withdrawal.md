...
- dapp connection code: [GCScript](examples/Multi%20Stake%20Withdrawal.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Multi%20Stake%20Withdrawal.html)
