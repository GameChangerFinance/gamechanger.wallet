...
- dapp connection code: [GCScript](examples/Load%20Wallet%20Config%20Demo.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Load%20Wallet%20Config%20Demo.html)
