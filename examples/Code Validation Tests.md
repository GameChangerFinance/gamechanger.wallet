...
- dapp connection code: [GCScript](examples/Code%20Validation%20Tests.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Code%20Validation%20Tests.html)
