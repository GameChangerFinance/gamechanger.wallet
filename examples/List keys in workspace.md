...
- dapp connection code: [GCScript](examples/List%20keys%20in%20workspace.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/List%20keys%20in%20workspace.html)
