...
-  Visit [HTML+JS Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Governance%20-%20Key%20Derivation%20Paths.html)
-  Visit [HTML+React Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Governance%20-%20Key%20Derivation%20Paths_react.html)
-  Visit [Native HTML dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Governance%20-%20Key%20Derivation%20Paths_nolib.html)
-  Run [Standalone URL dapp connection](https://wallet.gamechanger.finance/api/2/run/1-H4sIAAAAAAAAA5WPT2vDMAzFv4rxOSX9Fxi7jbS0o5cydhujaIkgpo7t2UrbUPrdJyXd2HHzwUZP7_0sXTX1AfWjTlU0gXSmyZAVYeNPGB24CtVE7bBXK4zmBGS8U3ugJrG3xjHGGifWl2B9RFV6d4ZerSOoI-fqnxwnIn52JjL_qp0nec5gLdIrT_HMkDeNF0KXxP1-u2VcBh_pKTG_BgJBdE5yAxb33Yc1FY-XRLvvMrYGMdPHe2_1gmH4FlrxSHlowbgDG9gWeCWW23z2UMwbvmdFk0-bfJFPNY9RlqW39a_8KPyFsPwmbMeF_w0oBCDnC-CSYZmtAQAA)

## Source code:

- dapp connection code: [GCScript DSL](Governance%20-%20Key%20Derivation%20Paths.gcscript)
- frontend (using @gamechanger-finance/gc): [HTML+JS dapp](Governance%20-%20Key%20Derivation%20Paths.html)
- frontend (using @gamechanger-finance/gc): [HTML+React dapp](Governance%20-%20Key%20Derivation%20Paths_react.html)
- frontend (without official library): [Native HTML dapp](Governance%20-%20Key%20Derivation%20Paths_nolib.html)
