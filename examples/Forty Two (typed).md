...
-  Visit [HTML5 Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Forty%20Two%20(typed).html)
...
- frontend (using @gamechanger-finance/gc): [HTML5 dapp](Forty%20Two%20(typed).html)
- frontend (without official library): [Native HTML5 dapp](Forty%20Two%20(typed)_nolib.html)
