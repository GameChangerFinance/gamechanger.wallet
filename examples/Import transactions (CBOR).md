...
- dapp connection code: [GCScript](examples/Import%20transactions%20(CBOR).gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Import%20transactions%20(CBOR).html)
