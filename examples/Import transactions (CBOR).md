...
- frontend (using @gamechanger-finance/gc): [HTML5 dapp](Import%20transactions%20(CBOR).html)
- frontend (without official library): [Native HTML5 dapp](Import%20transactions%20(CBOR)_nolib.html)
