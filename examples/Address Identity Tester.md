...
- dapp connection code: [GCScript](examples/Address%20Identity%20Tester.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Address%20Identity%20Tester.html)
