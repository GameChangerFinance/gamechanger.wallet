...
-  Visit [HTML+JS Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Script%20Requirements.html)
-  Visit [HTML+React Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Script%20Requirements_react.html)
-  Visit [Native HTML dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Script%20Requirements_nolib.html)
-  Run [Standalone URL dapp connection](https://wallet.gamechanger.finance/api/2/run/1-H4sIAAAAAAAAA22QMVIDMQxFryLcpMlwgHQMFS0kFUNhvNqNZx3bkWQ2O5ktuQWn4yTIWQ80VB49f_-v76sRLwHNzrw48lngGc_FE54wCput6ZBv3KeomgP7OMBKgP6U4I7oRgZJkGKYwYaQJrDgkMT6CIWRYFKKKk1R8CJVSyWCHD03x3s4MPYlBOgTwYbFu3EGRmZN541aQ2dzZtDbqmiGMmesKKJMiUbgjM733jXX2qJKdP0V6IyXnEgeWFlnxSppZczuamKSeqzue335pNVfzXuhiKTSwfdi3pataYF7O6hPJsyUOqNca1WDky5uh5tly29ZHzaUOn5_fcJjigNZ4TuYU_mtNFle_xC7__7JLMvyAwu_3f25AQAA)

## Source code:

- dapp connection code: [GCScript DSL](Script%20Requirements.gcscript)
- frontend (using @gamechanger-finance/gc): [HTML+JS dapp](Script%20Requirements.html)
- frontend (using @gamechanger-finance/gc): [HTML+React dapp](Script%20Requirements_react.html)
- frontend (without official library): [Native HTML dapp](Script%20Requirements_nolib.html)
