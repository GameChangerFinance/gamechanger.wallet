...
- dapp connection code: [GCScript](examples/Password%20Provider%20Demo.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Password%20Provider%20Demo.html)
