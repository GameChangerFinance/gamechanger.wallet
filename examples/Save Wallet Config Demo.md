...
- dapp connection code: [GCScript](examples/Save%20Wallet%20Config%20Demo.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Save%20Wallet%20Config%20Demo.html)
