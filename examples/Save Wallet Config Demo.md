...
-  Visit [HTML+JS Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Save%20Wallet%20Config%20Demo.html)
-  Visit [HTML+React Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Save%20Wallet%20Config%20Demo_react.html)
-  Visit [Native HTML dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Save%20Wallet%20Config%20Demo_nolib.html)
...
- frontend (using @gamechanger-finance/gc): [HTML+JS dapp](Save%20Wallet%20Config%20Demo.html)
- frontend (using @gamechanger-finance/gc): [HTML+React dapp](Save%20Wallet%20Config%20Demo_react.html)
- frontend (without official library): [Native HTML dapp](Save%20Wallet%20Config%20Demo_nolib.html)
