...
- dapp connection code: [GCScript](examples/Official%20Workspaces%20Config%20Generator.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Official%20Workspaces%20Config%20Generator.html)
