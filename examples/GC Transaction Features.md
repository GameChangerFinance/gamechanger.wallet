...
-  Visit [HTML+JS Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/GC%20Transaction%20Features.html)
-  Visit [HTML+React Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/GC%20Transaction%20Features_react.html)
-  Visit [Native HTML dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/GC%20Transaction%20Features_nolib.html)
...
- frontend (using @gamechanger-finance/gc): [HTML+JS dapp](GC%20Transaction%20Features.html)
- frontend (using @gamechanger-finance/gc): [HTML+React dapp](GC%20Transaction%20Features_react.html)
- frontend (without official library): [Native HTML dapp](GC%20Transaction%20Features_nolib.html)
