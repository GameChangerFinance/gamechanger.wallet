...
-  Visit [HTML+JS Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Keep%20Calm%20NFT.html)
-  Visit [HTML+React Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Keep%20Calm%20NFT_react.html)
-  Visit [Native HTML dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Keep%20Calm%20NFT_nolib.html)
...
- dapp connection code: [GCScript DSL](Keep%20Calm%20NFT.gcscript)
- frontend (using @gamechanger-finance/gc): [HTML+JS dapp](Keep%20Calm%20NFT.html)
- frontend (using @gamechanger-finance/gc): [HTML+React dapp](Keep%20Calm%20NFT_react.html)
- frontend (without official library): [Native HTML dapp](Keep%20Calm%20NFT_nolib.html)
...
[![This GCScript/URL is too large! make it shorter uploading parts to GCFS. Unable to generate QR code](Keep%20Calm%20NFT.png)](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Keep%20Calm%20NFT.png)
