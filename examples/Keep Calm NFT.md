...
-  Visit [HTML5 Dapp](https://gamechangerfinance.github.io/gamechanger.wallet/examples/Keep%20Calm%20NFT.html)
...
- frontend (using @gamechanger-finance/gc): [HTML5 dapp](Keep%20Calm%20NFT.html)
- frontend (without official library): [Native HTML5 dapp](Keep%20Calm%20NFT_nolib.html)
