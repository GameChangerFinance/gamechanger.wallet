...
- dapp connection code: [GCScript](examples/Wallet%20derivation%20script.gcscript)
- frontend + dapp connection code : [HTML5 dapp](examples/Wallet%20derivation%20script.html)
